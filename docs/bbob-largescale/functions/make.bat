...
set BUILDDIR=build
set HTMLBUILDDIR=../../../bbob-largescale/functions
set PDF=bbob-largescale-functions.pdf
set TEX=bbob-largescale-functions.tex
...
if "%1" == "help" (
	...
	echo.  html-topublish to make HTML files in the repository ../../../bbob-largescale/functions"
...
.qhcp project file in %BUILDDIR%/qthelp, like this:
	echo.^> qcollectiongenerator %BUILDDIR%\qthelp\largescale-functions.qhcp
	echo.To view the help file:
	echo.^> assistant -collectionFile %BUILDDIR%\qthelp\largescale-functions.ghc
	goto end
)
