...
set BUILDDIR=build
set HTMLBUILDDIR=../../../bbob-biobj/perf-assessment
set PDF=bbob-biobj-perf-assessment.pdf
set TEX=bbob-biobj-perf-assessment.tex
...
if "%1" == "help" (
	...
	echo.  html-topublish to make HTML files in the repository ..\..\..\bbob-biobj\perf-assessment"
...
if "%1" == "latexpdf" (
	...
	python ..\..\replace.py ".. FAKECHAPTERTITLE" "FAKECHAPTERTITLE" source\index.rst
