...
html_title = "COCO: COmparing Continuous Optimizers"
...
man_pages = [
  (master_doc, 'coco-doc.tex', u'Documentation of the Comparing Continuous Optimizers Platform Coco',
   [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'coco-doc.tex', u'Documentation of the Comparing Continuous Optimizers Platform Coco',
   author, 'coco-doc', 'One line description of project.',
   'Miscellaneous'),
]
